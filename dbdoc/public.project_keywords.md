...
| analysis_priority | varchar(16) |  | false |  |  |  |
| preferred_engine | varchar(32) |  | false |  |  |  |
...
| Name | Definition |
| ---- | ---------- |
| project_keywords_pkey | CREATE UNIQUE INDEX project_keywords_pkey ON public.project_keywords USING btree (id) |
| uk_project_keywords_project_text | CREATE UNIQUE INDEX uk_project_keywords_project_text ON public.project_keywords USING btree (project_id, keyword_text) |
