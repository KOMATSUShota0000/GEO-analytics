...
| som_score | double precision |  | true |  |  |  |
| brand_mentioned | boolean |  | false |  |  |  |
| mention_rank | integer |  | true |  |  |  |
| overall_score | integer |  | true |  |  |  |
| resolved_entity_label | varchar(512) |  | true |  |  |  |
| token_count | integer |  | false |  |  |  |
| ai_citation_position | integer |  | true |  |  |  |
| sentiment_intensity | double precision |  | false |  |  |  |
| visibility_stage | integer |  | true |  |  |  |
| calculation_version | varchar(32) |  | true |  |  |  |
| negative_alert | boolean |  | false |  |  |  |
| modified_z_score | double precision |  | true |  |  |  |
| diagnostic_message | text |  | true |  |  |  |
| recommended_actions | jsonb |  | true |  |  |  |
| model_insights | jsonb |  | true |  |  |  |
| audit_date | date |  | false |  |  |  |
| created_at | timestamp with time zone |  | false |  |  |  |
| gbvs_normalized_score | numeric |  | true |  |  |  |
| job_recommended_actions | jsonb |  | true |  |  |  |
| ai_recognition_state | varchar(32) |  | true |  |  |  |
...
| idx_audit_histories_tenant_project_date | CREATE INDEX idx_audit_histories_tenant_project_date ON public.audit_histories USING btree (tenant_id, project_id, audit_date) |
| idx_audit_histories_job_id | CREATE INDEX idx_audit_histories_job_id ON public.audit_histories USING btree (job_id) |
