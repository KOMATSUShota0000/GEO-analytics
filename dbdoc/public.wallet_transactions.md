...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| id | uuid |  | false | [public.wallet_transactions](public.wallet_transactions.md) |  |  |
| organization_id | uuid |  | false |  | [public.organizations](public.organizations.md) |  |
| project_id | uuid |  | true |  | [public.projects](public.projects.md) |  |
| transaction_type | varchar(32) |  | false |  |  |  |
| amount | bigint |  | false |  |  |  |
| parent_reservation_id | uuid |  | true |  | [public.wallet_transactions](public.wallet_transactions.md) |  |
| created_at | timestamp without time zone | now() | false |  |  |  |
| note | varchar(2048) |  | true |  |  |  |
...
| wallet_transactions_parent_reservation_id_fkey | FOREIGN KEY | FOREIGN KEY (parent_reservation_id) REFERENCES wallet_transactions(id) ON DELETE RESTRICT |
| wallet_transactions_pkey | PRIMARY KEY | PRIMARY KEY (id) |
...
| uq_parent_reservation | CREATE UNIQUE INDEX uq_parent_reservation ON public.wallet_transactions USING btree (parent_reservation_id) WHERE (parent_reservation_id IS NOT NULL) |
| idx_wallet_tx_org | CREATE INDEX idx_wallet_tx_org ON public.wallet_transactions USING btree (organization_id, created_at) |
