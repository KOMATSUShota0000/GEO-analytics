...
| ---- | ---- | ---------- |
| fk_job_queries_job | FOREIGN KEY | FOREIGN KEY (job_id) REFERENCES jobs(id) ON DELETE CASCADE |
| job_queries_pkey | PRIMARY KEY | PRIMARY KEY (id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| job_queries_pkey | CREATE UNIQUE INDEX job_queries_pkey ON public.job_queries USING btree (id) |
